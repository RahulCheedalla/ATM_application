...
public class SignupOne extends JFrame implements ActionListener {
    long random;
    JTextField nameTextField,fathersnameTextField,emailaddressTextField,addressTextField,cityTextField,stateTextField,pincodeTextField;
    JButton next;
    ...
    SignupOne(){ 
        ...
        //This is to allow either select male or female..
        ...
        maritialstatus.setBounds(100,440,200,30);
        add(maritialstatus);
        ...
        no.setBounds(400,440,60,30);
        no.setBackground(Color.WHITE);
        add(no);
        
        //This is to allow either select male or female..
        ButtonGroup maritialstatusgroup=new ButtonGroup();
        maritialstatusgroup.add(yes);
        maritialstatusgroup.add(no);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        //This is for handling exception in databases
        try{
            if(name.equals("")){
